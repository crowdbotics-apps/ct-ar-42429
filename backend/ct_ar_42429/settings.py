"""
Django settings for ct_ar_42429 project.
...
WSGI_APPLICATION = 'ct_ar_42429.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ct_ar_42429 API",
    "DESCRIPTION": "API documentation for ct_ar_42429 App",
    "VERSION": "v1",
}
